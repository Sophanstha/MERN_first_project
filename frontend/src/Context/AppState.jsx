...
return (
        <AppContext.Provider value={{AminRegister,userAddress,decreaseqty,removecart,updateAddress, cart,getUserAddress,setcart,product,register,login,token,url,isAuth,setIsAuth,logout,user,addtocart }}>  {/* Wrapped data in an object */}
            {props.children}
        </AppContext.Provider>
    )
}
